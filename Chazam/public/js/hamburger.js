                ...
                amistades.forEach(amigo => {
                    ...
                    amigoItem.innerHTML = `
                        <div class="d-flex align-items-center">
                            <img src="${amigo.img ? (amigo.img.startsWith('http') ? amigo.img : window.location.origin + '/img/profile_img/' + amigo.img.replace('/img/profile_img/', '')) : '/img/profile_img/avatar-default.png'}" 
