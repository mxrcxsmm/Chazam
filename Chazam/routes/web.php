...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/donar/success', function () {
        return view('stripe.success'); // Vista de éxito
    })->name('stripe.success');
    Route::get('/donar/cancel', function () {
        return view('stripe.cancel'); // Vista de cancelación
    })->name('stripe.cancel');
