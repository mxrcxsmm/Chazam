...
<meta name="user-img" content="{{ Auth::user()->img ? '/img/profile_img/' . Auth::user()->img : asset('img/profile_img/avatar-default.png') }}">
    ...
    <div class="chat-main">
        <div class="chat-header">
            <div class="chat-contact">
                <img id="chat-contact-img" src="{{ Auth::user()->img ? '/img/profile_img/' . Auth::user()->img : asset('img/profile_img/avatar-default.png') }}" alt="Contact Avatar">
...
<script>
window.userImg = "{{ Auth::user()->img ? '/img/profile_img/' . Auth::user()->img : asset('img/profile_img/avatar-default.png') }}";
</script>