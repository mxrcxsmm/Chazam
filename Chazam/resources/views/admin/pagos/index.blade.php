                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="filtro-campo">
                            ...
                            <input type="text" class="form-control" id="filtro_id" name="filtro_id" placeholder="Buscar por ID">
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="filtro-campo">
                            <label for="filtro_comprador">Nombre de Comprador</label>
                            <input type="text" class="form-control" id="filtro_comprador" name="filtro_comprador" placeholder="Buscar por nombre de comprador">
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="filtro-campo">
                            <label for="filtro_producto">Nombre de Producto</label>
                            <input type="text" class="form-control" id="filtro_producto" name="filtro_producto" placeholder="Buscar por nombre de producto">
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="filtro-campo">
                            <label for="filtro_fecha_pago">Fecha de pago</label>
                            <input type="text" class="form-control" id="filtro_fecha_pago" name="filtro_fecha_pago" placeholder="Buscar por fecha de pago">
                        </div>
                    </div>
